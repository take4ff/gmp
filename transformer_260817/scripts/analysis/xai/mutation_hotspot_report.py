# --- transformer_260817/scripts/analysis/mutation_hotspot_report.py ---
"""⑦ 遺伝子別・位置別の変異蓄積傾向レポート。
...
Usage:
  python -m transformer_260817.scripts.analysis.xai.mutation_hotspot_report \\
...
from transformer_260817.scripts.analysis.xai.local_explain import KNOWN_VOC_POSITIONS
