# --- transformer_260817/scripts/analysis/local_explain.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.xai.local_explain \\
  ...
  python -m transformer_260817.scripts.analysis.xai.local_explain \\
      --walk_forward_dir outputs/transformer_260817/results/walk_forward/<timestamp> --fold 3 --n_samples 8
  ...
  python -m transformer_260817.scripts.analysis.xai.local_explain \\
      --walk_forward_dir outputs/transformer_260817/results/walk_forward/<timestamp> --n_samples 8
"""
...
from transformer_260817.scripts.analysis.feature_importance import _NUM_FEATURE_NAMES
