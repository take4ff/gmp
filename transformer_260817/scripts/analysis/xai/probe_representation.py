# --- transformer_260817/scripts/analysis/probe_representation.py ---
"""⑤ 内部表現のプロービング。
...
Usage:
  python -m transformer_260817.scripts.analysis.xai.probe_representation \\
  ...
  python -m transformer_260817.scripts.analysis.xai.probe_representation \\
      --walk_forward_dir outputs/transformer_260817/results/walk_forward/<timestamp> --n_batches 150
"""
