# --- transformer_260817/scripts/analysis/timestep_importance.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.xai.timestep_importance \\
...
from transformer_260817.scripts.analysis.xai.local_explain import _integrated_gradients
