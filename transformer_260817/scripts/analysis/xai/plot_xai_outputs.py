# --- transformer_260817/scripts/visualization/plot_xai_outputs.py ---
...
Usage:
  python -m transformer_260817.scripts.visualization.plot_xai_outputs local_explain \\
      --json outputs/transformer_260817/scripts/local_explain/<ts>/local_explanations.json
  python -m transformer_260817.scripts.visualization.plot_xai_outputs constellation \\
      --dir outputs/transformer_260817/scripts/constellation_walk_forward/<ts>
  python -m transformer_260817.scripts.visualization.plot_xai_outputs majority_baseline \\
      --csv outputs/transformer_260817/scripts/majority_baseline/<ts>/majority_baseline_by_fold.csv
"""
