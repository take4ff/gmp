# --- transformer_260817/scripts/feature_importance.py ---
...
Usage:
    python -m transformer_260817.scripts.feature_importance \\
        --checkpoint outputs/transformer_260817/results/<timestamp>/models/best_model.pth \\
