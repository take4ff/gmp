# --- transformer_260817/scripts/analysis/verify/verify_coattn_frequency_confound.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.verify.verify_coattn_frequency_confound \\
      --walk_forward_dir outputs/transformer_260817/results/walk_forward/20260719_001947 \\
      --node_signals_csv outputs/transformer_260817/scripts/timetree_model/<ts>/timetree_node_signals.csv \\
...
from transformer_260817.scripts.analysis.xai.lineage_attention_compare import _build_single_sample_batch
from transformer_260817.scripts.visualization.plot_timetree_model import _collect_lineage_samples
from transformer_260817.scripts.visualization.plot_timetree import get_group
