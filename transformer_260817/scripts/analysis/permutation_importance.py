# --- transformer_260817/scripts/analysis/permutation_importance.py ---
...
Usage:
    python -m transformer_260817.scripts.analysis.permutation_importance \\
        --checkpoint outputs/transformer_260817/results/<ts>/models/best_model.pth \\
