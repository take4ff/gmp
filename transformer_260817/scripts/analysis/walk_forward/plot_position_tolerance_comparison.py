# --- transformer_260817/scripts/analysis/walk_forward/plot_position_tolerance_comparison.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.walk_forward.plot_position_tolerance_comparison \
      --main_csv outputs/transformer_260817/scripts/position_tolerance_monthly/<ts>/position_tolerance_monthly.csv \
      ...
      [--fano_csv outputs/transformer_260817/scripts/entropy_accuracy/by_month/entropy_fano_by_month.csv]
"""
import argparse
import os
import re
