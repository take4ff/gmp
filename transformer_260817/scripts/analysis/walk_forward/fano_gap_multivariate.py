# --- transformer_260817/scripts/analysis/walk_forward/fano_gap_multivariate.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.walk_forward.fano_gap_multivariate \\
      --fano_csv outputs/transformer_260817/scripts/entropy_accuracy/<ts>/entropy_accuracy_pooled_lineages.csv \\
      --drivers_csv outputs/transformer_260817/scripts/lineage_accuracy_drivers/<ts>/lineage_accuracy_drivers_pooled.csv
"""
import argparse
