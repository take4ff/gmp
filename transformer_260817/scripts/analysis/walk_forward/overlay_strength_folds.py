# --- transformer_260817/scripts/analysis/walk_forward/overlay_strength_folds.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.walk_forward.overlay_strength_folds \
