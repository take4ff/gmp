# --- transformer_260817/scripts/analysis/walk_forward/position_tolerance_monthly.py ---
...
Usage:
  python -m transformer_260817.scripts.analysis.walk_forward.position_tolerance_monthly \
