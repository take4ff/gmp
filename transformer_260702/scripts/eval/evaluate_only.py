# --- transformer_260702/scripts/evaluate_only.py ---
# 既存チェックポイントを使って評価のみ実行する。学習は行わない。
#
# Usage:
#   python -m transformer_260702.scripts.evaluate_only \
#       --checkpoint outputs/transformer_260702/results/<timestamp>/models/best_model.pth
#
...
from transformer_260702.model import HierarchicalTransformer, MultiTaskLoss
from transformer_260702.evaluate import evaluate, evaluate_topk
from transformer_260702.utils.losses import build_loss_fn
from transformer_260702.utils.logging import force_print, print_config
from transformer_260702.utils.io import (
    save_config_copy,
...
from transformer_260702.utils.plotting import (
...
from transformer_260702.main import prepare_data
...
def main():
    ...
    # 損失関数・モデル構築
    if config.USE_DB:
        from transformer_260702.db.queries import get_train_class_counts
