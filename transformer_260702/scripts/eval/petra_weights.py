# --- transformer_260702/scripts/eval/petra_weights.py ---
...
def get_strain_country_map(db_path, split_type):
    ...
    """
    from transformer_260702.db.connection import connect_db
    from transformer_260702.db.queries import get_split_col
