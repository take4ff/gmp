# --- transformer_260707/scripts/analysis/walk_forward/monthly_diversity_accuracy.py ---
...
Usage:
  python -m transformer_260707.scripts.analysis.walk_forward.monthly_diversity_accuracy \
