# --- transformer_260707/scripts/analysis/walk_forward/overlay_strength_folds.py ---
...
Usage:
  python -m transformer_260707.scripts.analysis.walk_forward.overlay_strength_folds \
