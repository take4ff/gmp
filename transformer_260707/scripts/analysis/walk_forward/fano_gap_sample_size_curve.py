# --- transformer_260707/scripts/analysis/walk_forward/fano_gap_sample_size_curve.py ---
...
Usage:
  python -m transformer_260707.scripts.analysis.walk_forward.fano_gap_sample_size_curve \\
