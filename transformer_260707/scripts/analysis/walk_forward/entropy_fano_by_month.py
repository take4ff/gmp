# --- transformer_260707/scripts/analysis/walk_forward/entropy_fano_by_month.py ---
...
Usage:
    python -m transformer_260707.scripts.analysis.walk_forward.entropy_fano_by_month \\
...
def main():
    ...
    out_dir = args.output_dir or os.path.join('outputs', 'transformer_260707', 'scripts',
