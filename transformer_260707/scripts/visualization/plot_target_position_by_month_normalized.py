# --- transformer_260707/scripts/visualization/plot_target_position_by_month_normalized.py ---
...
# Usage: python -m transformer_260707.scripts.visualization.plot_target_position_by_month_normalized
import os
import pickle
