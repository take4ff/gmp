...
model_config = {
    ...
    'graph_optimization': {
        ...
        'max_graph_connections': 10,     # 最大接続数制限
        'similarity_threshold': 0.7,     # 類似性閾値を上げて接続数削減
        'batch_graph_construction': True, # バッチ単位でのグラフ構築
        'use_sparse_attention': False    # スパース注意機構（実験的）
    }
}
