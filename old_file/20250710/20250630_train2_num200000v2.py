...
if len(train_x) > data_config['train_num']:
    print(f"訓練データが{len(train_x)}サンプルあります。最大{data_config['train_num']}サンプルに制限します。")
    train_x = train_x[:data_config['train_num']]
    train_y = train_y[:data_config['train_num']]
