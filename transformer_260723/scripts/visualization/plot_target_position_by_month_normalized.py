# --- transformer_260723/scripts/visualization/plot_target_position_by_month_normalized.py ---
...
# Usage: python -m transformer_260723.scripts.visualization.plot_target_position_by_month_normalized
import os
import pickle
