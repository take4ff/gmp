# --- transformer_260723/scripts/visualization/plot_timetree_model.py ---
...
#
# Usage:
#   python -m transformer_260723.scripts.visualization.plot_timetree_model \
#       --walk_forward_dir outputs/transformer_260723/results/walk_forward/20260719_001947 \
#       [--pooled_csv outputs/transformer_260723/scripts/entropy_accuracy/<ts>/entropy_accuracy_pooled_lineages.csv] \
...
from transformer_260723.scripts.analysis.xai.lineage_attention_compare import (
    _build_single_sample_batch, _find_fold_for_date)
from transformer_260723.scripts.visualization.plot_timetree import (
...
def _latest_pooled_csv():
    ...
    candidates = sorted(glob.glob(os.path.join(
        'outputs', 'transformer_260723', 'scripts', 'entropy_accuracy',
