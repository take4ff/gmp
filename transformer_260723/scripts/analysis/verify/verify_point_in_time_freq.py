# --- transformer_260723/scripts/analysis/verify/verify_point_in_time_freq.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.verify.verify_point_in_time_freq \\
...
from transformer_260723.evaluate import evaluate_topk
