# --- transformer_260723/scripts/analysis/verify/verify_batch_local_grouping.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.verify.verify_batch_local_grouping
  python -m transformer_260723.scripts.analysis.verify.verify_batch_local_grouping --folds 2 6
"""
import argparse
import random
import re
