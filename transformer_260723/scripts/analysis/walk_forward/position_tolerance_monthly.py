# --- transformer_260723/scripts/analysis/walk_forward/position_tolerance_monthly.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.position_tolerance_monthly \
