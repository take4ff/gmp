# --- transformer_260723/scripts/analysis/walk_forward/entropy_accuracy_analysis.py ---
...
Usage:
    python -m transformer_260723.scripts.analysis.walk_forward.entropy_accuracy_analysis \\
