# --- transformer_260723/scripts/analysis/walk_forward/overlay_region_folds.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.overlay_region_folds \
