# --- transformer_260723/scripts/analysis/walk_forward/fano_gap_sample_size_curve.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.fano_gap_sample_size_curve \\
