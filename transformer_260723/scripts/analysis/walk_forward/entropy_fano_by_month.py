# --- transformer_260723/scripts/analysis/walk_forward/entropy_fano_by_month.py ---
...
Usage:
    python -m transformer_260723.scripts.analysis.walk_forward.entropy_fano_by_month \\
...
def main():
    ...
    out_dir = args.output_dir or os.path.join('outputs', 'transformer_260723', 'scripts',
    ...
    if len(axes) > 1:
        from transformer_260723.scripts.visualization._fold_annotate import _month_to_fold
