# --- transformer_260723/scripts/analysis/walk_forward/predicted_position_by_month.py ---
...
#
# Usage:
#   python -m transformer_260723.scripts.analysis.walk_forward.predicted_position_by_month \
