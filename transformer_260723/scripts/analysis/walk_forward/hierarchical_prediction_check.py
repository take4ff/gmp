# --- transformer_260723/scripts/analysis/walk_forward/hierarchical_prediction_check.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.hierarchical_prediction_check \\
