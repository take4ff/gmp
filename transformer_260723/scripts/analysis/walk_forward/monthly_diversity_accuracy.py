# --- transformer_260723/scripts/analysis/walk_forward/monthly_diversity_accuracy.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.monthly_diversity_accuracy \
