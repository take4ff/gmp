# --- transformer_260723/scripts/analysis/walk_forward/plot_position_tolerance_all_tol.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.plot_position_tolerance_all_tol \\
