# --- transformer_260723/scripts/analysis/walk_forward/run_all_walk_forward_plots.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.walk_forward.run_all_walk_forward_plots \\
...
BASE = 'transformer_260723.scripts.analysis.walk_forward'
...
def main():
    ...
    parent = args.output_dir or os.path.join(
        'outputs', 'transformer_260723', 'scripts', 'walk_forward_plots_all', ts)
