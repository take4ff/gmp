# --- transformer_260723/scripts/analysis/xai/run_all_xai_walk_forward.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.xai.run_all_xai_walk_forward \\
...
BASE = 'transformer_260723.scripts.analysis.xai'
...
def main():
    ...
    parent = args.output_dir or os.path.join(
        'outputs', 'transformer_260723', 'scripts', 'xai_all_walk_forward', ts)
