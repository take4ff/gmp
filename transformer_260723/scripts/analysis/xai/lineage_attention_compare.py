# --- transformer_260723/scripts/analysis/lineage_attention_compare.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.xai.lineage_attention_compare \\
...
from transformer_260723.db.dataset import DBIterableDataset, _NUM_MASK_KEYS_BASE
...
from transformer_260723.scripts.analysis.xai.lineage_evolution_track import pick_representative_samples
...
def _build_single_sample_batch(db_path, sample_id):
    ...
    if getattr(config, 'USE_LINEAGE_GROWTH_FEATURES', False):
        from transformer_260723.db.dataset import _NUM_MASK_KEYS_GROWTH
