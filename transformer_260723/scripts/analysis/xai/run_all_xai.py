# --- transformer_260723/scripts/analysis/run_all_xai.py ---
...
Usage:
  python -m transformer_260723.scripts.analysis.xai.run_all_xai \\
...
def main():
    ...
    parent = args.output_dir or os.path.join(
        'outputs', 'transformer_260723', 'scripts', 'xai_all', ts)
