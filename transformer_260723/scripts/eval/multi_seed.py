...
Usage:
    ...
    python -m transformer_260723.scripts.eval.multi_seed
    # シードを明示指定
    python -m transformer_260723.scripts.eval.multi_seed --seeds 42 1 7 123
...
def main():
    ...
    from transformer_260723.main import _run_entry
