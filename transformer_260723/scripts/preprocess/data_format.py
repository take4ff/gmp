# --- transformer_260723/scripts/data_format.py ---
# UShER 出力の mutation-paths.txt を mutation_paths.tsv に変換する前処理スクリプト。
# preprocess.py より先に実行する（1回限りの変換処理）。
# Usage: python -m transformer_260723.scripts.preprocess.data_format
#        python -m transformer_260723.scripts.preprocess.data_format --base-dir ../usher_output2/
import argparse
import os
import re
import pandas as pd
