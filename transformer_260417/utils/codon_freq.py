...
【使い方】
  from transformer_260417.utils.codon_freq import compute_codon_freq, save_codon_freq
  ...
  nohup conda run -n gvp25-05 python3 -m transformer_260417.utils.codon_freq \
  --usher_dir /mnt/ssd1/home3/aiba/usher_output \
  --codon_csv meta_data/codon_mutation4.csv \
